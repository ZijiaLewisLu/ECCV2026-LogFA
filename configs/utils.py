...
def setup_cfg(cfg_file=[], set_cfgs=None, default: CfgNode=None, rename_dict=RENAME_KEYS, logdir="log_unified/") -> CfgNode:
    """
    ...
    split = cfg.split if cfg.recipe is None else f"{cfg.recipe}_{cfg.split}"
    logdir = os.path.join(logdir, cfg.dataset, split,
...
def load_cfg_json(cfg_file, update_cfg=False):
